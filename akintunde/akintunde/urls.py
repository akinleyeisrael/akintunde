...
urlpatterns = [
    ...
    path("video/uploadVideo/", views.upload_video, name="video-upload"),
    ...
    path("exhibition/create", views.createExhibition, name="create-exhibition"),
    path("exhibition/edit/<str:pk>/", views.editExhibition, name="edit-exhibition"),
    path("exhibition/delete/<str:pk>/", views.deleteExhibition, name="delete-exhibition"),
]
